========================================================================
    KONSOLENANWENDUNG: Sensorsteuerung-Projektübersicht
========================================================================

Diese Sensorsteuerung-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre Sensorsteuerung-Anwendung besteht.


Sensorsteuerung.vcxproj
...
Sensorsteuerung.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen Sensorsteuerung.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
